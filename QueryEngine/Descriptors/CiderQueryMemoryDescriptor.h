...
class CiderQueryMemoryDescriptor {
 public:
  CiderQueryMemoryDescriptor();

  // constructor for init call
  CiderQueryMemoryDescriptor(const Executor* executor,
  ...
  CiderQueryMemoryDescriptor(const QueryDescriptionType query_desc_type,
  ...
  // Serialization
  CiderQueryMemoryDescriptor(const TResultSetBufferDescriptor& thrift_query_memory_descriptor);
  static TResultSetBufferDescriptor toThrift(const CiderQueryMemoryDescriptor&);

  bool operator==(const CiderQueryMemoryDescriptor& other) const;

  static std::unique_ptr<CiderQueryMemoryDescriptor> init(
