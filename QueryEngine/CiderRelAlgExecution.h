...
#ifndef QUERYENGINE_CIDERRELALGEXECUTIONUNIT_H
#define QUERYENGINE_CIDERRELALGEXECUTIONUNIT_H
...
struct CiderRelAlgExecutionUnit {
...
std::ostream& operator<<(std::ostream& os, const CiderRelAlgExecutionUnit& ra_exe_unit);
std::string ra_exec_unit_desc_for_caching(const CiderRelAlgExecutionUnit& ra_exe_unit);
...
#endif  // QUERYENGINE_CIDERRELALGEXECUTIONUNIT_H
