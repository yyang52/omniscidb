...
#ifndef QUERYENGINE_CIDERGROUPBYANDAGGREGATE_H
#define QUERYENGINE_CIDERGROUPBYANDAGGREGATE_H
...
class CiderGroupByAndAggregate {
 public:
  CiderGroupByAndAggregate(
...
#endif  // QUERYENGINE_CIDERGROUPBYANDAGGREGATE_H
